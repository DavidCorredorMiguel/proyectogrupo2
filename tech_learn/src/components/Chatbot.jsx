...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([ // useState es un hook de React que permite agregar estado a componentes funcionales, un hook es una función especial que permite "engancharse" a las características de React.
